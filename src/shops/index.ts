export { scrapeSirenaPrice } from "./sirena.js";
export { scrapeNacionalPrice } from "./nacional.js";
export { scrapeJumboPrice } from "./jumbo.js";
export { scrapeMercaJumboPrice } from "./merca-jumbo.js";
