...
export const productsShopsPrices = pgTable(
  "products_shops_prices",
  {
    ...
    maximumPurchaseQuantity: numeric("maximumPurchaseQuantity"),
    priceReferenceQuantity: numeric("priceReferenceQuantity"),
    purchaseTermsSource: text("purchaseTermsSource"),
    purchaseTermsEvidence: jsonb("purchaseTermsEvidence"),
    purchaseTermsObservedAt: timestamp("purchaseTermsObservedAt", {
      withTimezone: true,
    }),
